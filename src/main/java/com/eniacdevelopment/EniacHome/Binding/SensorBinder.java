...
import com.eniacdevelopment.EniacHome.Repositories.ElasticSearch.SensorInfoRepositoryImpl;
...
public class SensorBinder extends AbstractBinder {
    ...
    protected void configure() {
        ...
        bind(SensorInfoRepositoryImpl.class).to(SensorInfoRepository.class);
